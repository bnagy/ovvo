...
If I made no errors while checking, and the real error rate were 5\%, then the probability of seeing no errors in a sample of 200 results is around 1 in 2500.
